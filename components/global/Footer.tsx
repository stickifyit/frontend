...
export default function Footer  (props: Props) {
  return (
    ...
    >
        <div className='container gap-8 flex-1 justify-between flex items-center '>
            <div className='p-8 flex gap-2 items-center w-fit flex-col'>
            ...
            <div className='flex-1'>
               <div className='flex justify-center'>
                <div className='w-[2px] bg-slate-200 mx-4'></div>
        ...
        <div className='h-10 bg-secondary text-white text-center flex items-center justify-center font-sans'>
